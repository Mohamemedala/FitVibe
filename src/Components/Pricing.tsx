...
import { CheckCircle } from 'lucide-react'; // أيقونة لعلامة الصح
    ...
    return (
        <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl text-center">
                <h2 className="text-base font-semibold text-black tracking-tighter ">Pricing</h2>
                <p className="mt-2 text-5xl font-semibold tracking-tighter text-gray-900 sm:text-6xl">
                    Choose the right plan for you
                </p>
            </div>
            <p className="mx-auto mt-6 max-w-xl tracking-tighter text-center text-lg font-medium text-gray-600 sm:text-xl">
